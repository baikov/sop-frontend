            ...
            <div class="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <ul role="list" class="mt-8 space-y-8 text-gray-600">
                <li class="flex gap-x-3">
                  <Icon name="mdi:cloud-arrow-left-outline" class="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                ...
                <li class="flex gap-x-3">
                  <Icon name="mdi:lock-alert-outline" class="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                ...
                <li class="flex gap-x-3">
                  <Icon name="mdi:server" class="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
