    ...
    <div class="container w-full max-w-7xl px-4 py-10 mx-auto">
      <div class="lg:flex lg:items-center">
        <div class="w-full space-y-12 lg:w-1/2 ">
          ...
          <div class="md:flex md:items-start md:-mx-4">
            <span class="inline-block p-2 text-green-700 bg-green-100 rounded-xl md:mx-4 dark:text-white dark:bg-green-500">
              <Icon name="mdi:ruble" />
            </span>
        ...
        <div class="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
          <img class="w-[28rem] h-[28rem] object-cover xl:w-[34rem] xl:h-[34rem] rounded-full" src="~/assets/img/armatira.png" alt="">
        </div>
      </div>
      ...
      <div class="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
        <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
          ...
          <img class="col-span-2 max-h-8 w-full object-contain lg:col-span-1" src="~/assets/img/partners/chtpz.png" alt="ЧТПЗ" width="150" height="35">
        </div>

        <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
          <img class="col-span-2 max-h-8 w-full object-contain lg:col-span-1" src="~/assets/img/partners/mech.png" alt="МЕЧЕЛ" width="150" height="40">
        </div>

        <div class="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
          <img class="col-span-2 max-h-8 w-full object-contain lg:col-span-1" src="~/assets/img/partners/mmk.gif" alt="ММК" width="150" height="34">
        </div>

        <div class="flex items-center justify-center col-span-1 md:col-span-3 lg:col-span-1">
          <img class="col-span-2 max-h-12 w-full object-contain sm:col-start-2 lg:col-span-1" src="~/assets/img/partners/omk.png" alt="ОМК" width="146" height="46">
        </div>

        <div class="flex items-center justify-center col-span-2 md:col-span-3 lg:col-span-1">
          <img class="col-span-2 col-start-2 max-h-8 w-full object-contain sm:col-start-auto lg:col-span-1" src="~/assets/img/partners/Severstal.jpg" alt="Statamic" width="150" height="50">
        </div>
      </div>
    </div>
  </section>
