            ...
            <div class="flex flex-wrap pt-12 lg:pt-0">
              <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                <div class="flex items-start">
                  <div class="shrink-0">
                    <div class="p-4 bg-green-600 rounded-md shadow-md w-14 h-14 flex items-center justify-center">
      ...
      <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
        <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
          ...
          <div>
            ...
            <p class="mt-2 text-sm text-green-700 dark:text-green-400">
              603095, Нижегородская область, г Нижний Новгород, пр-кт Бусыгина, д. 1, офис 325
            </p>
          </div>
